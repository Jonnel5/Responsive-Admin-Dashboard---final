...
<head>
    ...
    <title>Login</title>
    <link rel="stylesheet" href="./assets/css/style.css"> <!-- Assuming you have a style.css file for styling -->
</head>

<body>
    <div class="container">
        <h2>Login</h2>
        <form id="loginForm" action="./pages/maindashboard.php" method="post">
